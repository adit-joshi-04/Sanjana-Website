...
`;
  ...
  function buildFlowerSVGs() {
    var f0 = '<svg xmlns="http://www.w3.org/2000/svg" width="87" height="87" viewBox="0 0 87 87">'
      + '<defs><radialGradient id="f0bg" cx="0.5" cy="0.5" r="0.5"><stop offset="0" stop-color="#FFD93D"/><stop offset="1" stop-color="#F5A623"/></radialGradient></defs>'
    ...
    var f3 = '<svg xmlns="http://www.w3.org/2000/svg" width="90" height="94" viewBox="0 0 90 94">'
      + '<defs><radialGradient id="f3g" cx="0.5" cy="0.5" r="0.55"><stop offset="0" stop-color="#FF9A9E"/><stop offset="0.5" stop-color="#E84393"/><stop offset="1" stop-color="#C2185B"/></radialGradient></defs>'
    ...
    var f4 = '<svg xmlns="http://www.w3.org/2000/svg" width="95" height="95" viewBox="0 0 95 95">'
      + '<defs><radialGradient id="f4bg" cx="0.48" cy="0.49" r="0.55" gradientUnits="objectBoundingBox"><stop offset="0.04" stop-color="#0096CA"/><stop offset="0.76" stop-color="#39CEF2"/></radialGradient></defs>'
      + '<svg x="37.006" y="8.848" width="1.092" height="78.078" viewBox="0 0 22 76"><path d="M1.05291 1.80713e-05L0 0.289551L20.7139 75.5698L21.7668 75.2803L1.05291 1.80713e-05Z" fill="#457F42"/></svg>'
      + '<svg x="12.98" y="56.695" width="78.099" height="1.092" viewBox="0 0 76 22"><path d="M75.3005 5.78052e-06L0 20.7205L0.289808 21.773L75.5903 1.05253L75.3005 5.78052e-06Z" fill="#457F42"/></svg>'
      + '<svg x="14.163" y="28.971" width="1.092" height="78.095" viewBox="0 0 69 40"><path d="M0.539724 -9.62018e-06L0 0.949005L67.895 39.5379L68.4347 38.5889L0.539724 -9.62018e-06Z" fill="#457F42"/></svg>'
      + '<svg x="28.715" y="81.182" width="78.082" height="1.092" viewBox="0 0 40 69"><path d="M38.6011 -1.03417e-06L0 67.8735L0.949315 68.4131L39.5504 0.539553L38.6011 -1.03417e-06Z" fill="#457F42"/></svg>'
      + '<svg x="49.879" y="78.23" width="16.801" height="16.771" viewBox="0 0 17 17"><path d="M6.01817 0.323791C10.3234 -0.956194 15.1775 1.68566 16.4688 6.01141C17.7628 10.3508 15.1529 15.1542 10.7985 16.4478C6.48228 17.7278 1.60369 15.0832 0.326035 10.7711C-0.957085 6.44261 1.67195 1.61469 6.0209 0.323791H6.01817Z" fill="url(#f4bg)"/></svg>'
      + '<svg x="19.047" y="74.419" width="16.775" height="16.693" viewBox="0 0 17 17"><path d="M0.350173 10.7204C-0.973898 6.31277 1.57323 1.65953 6.02866 0.346792C10.4759 -0.963214 15.147 1.55309 16.441 5.95798C17.7351 10.3629 15.1497 15.1035 10.768 16.3643C6.33715 17.6361 1.66878 15.1089 0.350173 10.7204Z" fill="url(#f4bg)"/></svg>'
      + '<svg x="74.428" y="59.173" width="16.773" height="16.722" viewBox="0 0 17 17"><path d="M6.05046 0.325813C10.4458 -0.951443 15.1934 1.64674 16.4492 6.01888C17.7214 10.4456 15.1306 15.1534 10.7379 16.4034C6.31254 17.6616 1.60049 15.0825 0.325559 10.7076C-0.952101 6.32182 1.64963 1.6058 6.05046 0.325813Z" fill="url(#f4bg)"/></svg>'
      + '<svg x="3.813" y="19.053" width="16.769" height="16.715" viewBox="0 0 17 17"><path d="M6.37567 0.2637C10.8202 -0.890743 15.4285 1.85754 16.5232 6.31429C17.6262 10.8065 14.907 15.3533 10.4462 16.475C6.04806 17.5803 1.27868 14.7475 0.235804 10.4108C-0.842563 5.92675 1.87656 1.43452 6.37294 0.2637H6.37567Z" fill="url(#f4bg)"/></svg>'
      + '<svg x="59.191" y="3.821" width="16.788" height="16.691" viewBox="0 0 17 17"><path d="M6.37919 0.247881C10.8319 -0.865624 15.4184 1.87993 16.5377 6.32576C17.6597 10.7852 14.9024 15.3512 10.4197 16.4565C5.99698 17.5454 1.26036 14.7234 0.228403 10.3841C-0.836313 5.91093 1.92376 1.36139 6.37646 0.247881H6.37919Z" fill="url(#f4bg)"/></svg>'
      + '<svg x="0" y="49.888" width="16.753" height="16.692" viewBox="0 0 17 17"><path d="M6.06058 0.331368C10.4559 -0.954076 15.1434 1.61681 16.4347 6.02717C17.7069 10.372 15.037 15.1699 10.6716 16.3762C6.17524 17.6207 1.59423 15.0826 0.330219 10.6477C-0.944711 6.17727 1.57239 1.6441 6.06058 0.331368Z" fill="url(#f4bg)"/></svg>'
      + '<svg x="28.346" y="0.0005" width="16.792" height="16.671" viewBox="0 0 17 17"><path d="M6.00867 0.351565C10.4723 -0.9639 15.127 1.52511 16.4456 5.93274C17.7588 10.3185 15.2198 14.9772 10.789 16.3091C6.34174 17.6464 1.67336 15.1574 0.349294 10.747C-0.972046 6.33938 1.57235 1.66157 6.00867 0.351565Z" fill="url(#f4bg)"/></svg>'
      + '<svg x="78.325" y="28.336" width="16.674" height="16.782" viewBox="0 0 17 17"><path d="M16.3965 6.25362C17.5732 10.6913 14.9005 15.32 10.4751 16.5044C6.05788 17.6861 1.46595 14.9788 0.281113 10.492C-0.900995 6.02437 1.75261 1.46664 6.22169 0.282172C10.688 -0.902292 15.2035 1.74774 16.3965 6.25362Z" fill="url(#f4bg)"/></svg>'
      + '</svg>';
